...
class _DownloadState extends State<Download> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      title: Text("Download",style: TextStyle(color: dark2),),
      centerTitle: true,
    ),
      backgroundColor: dark,
      body: Center(child: Text('Download',style: TextStyle(color: dark2),)),
    );
  }
}
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: "https://source.unsplash.com/random?Nature=$index",
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => PhotoA(
                           url: "https://source.unsplash.com/random?Nature=$index",
                        )),
              );
            },
            ////////////////////////////////
          ...
          child: InkWell(
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  bottom: 0,
                  child: CachedNetworkImage(
                    imageUrl: "https://source.unsplash.com/random?Travel=$index",
                    placeholder: (context, url) => CircularProgressIndicator(),
                    errorWidget: (context, url, error) => Icon(Icons.error),
                    fit: BoxFit.fill,
                  ),
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => PhotoA(
                           url: "https://source.unsplash.com/random?Travel=$index",
                        )),
              );
            },
            ////////////////////////////////
          ...
          child: InkWell(
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  bottom: 0,
                   child: CachedNetworkImage(
                    imageUrl: "https://source.unsplash.com/random?Animals=$index",
                    placeholder: (context, url) => CircularProgressIndicator(),
                    errorWidget: (context, url, error) => Icon(Icons.error),
                    fit: BoxFit.fill,
                  ),
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => PhotoA(
                          url: "https://source.unsplash.com/random?Animals=$index"
                        )),
              );
            },
            ////////////////////////////////
          ...
          child: InkWell(
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  bottom: 0,
                  child: CachedNetworkImage(
                    imageUrl: "https://source.unsplash.com/random?People=$index",
                    placeholder: (context, url) => CircularProgressIndicator(),
                    errorWidget: (context, url, error) => Icon(Icons.error),
                    fit: BoxFit.fill,
                  ),
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => PhotoA(
                          url: "https://source.unsplash.com/random?People=$index",
                        )),
              );
            },
            ////////////////////////////////
